...
/**
 * struct info- this struct for the program's data
 * @program_name: this the name of the executable
 * @input_line: this pointer to the input read for _getline
 * @command_name: this pointer to the first command typed by the user
 * @exec_counter: this number of excecuted comands
 * @file_descriptor: this file descriptor to the input of commands
 * @tokens: this pointer to array of tokenized input
 * @env: this copy of the environ
 * @alias_list: thi s array of pointers with aliases.
 */
typedef struct info
{
	char *program_name;
...
/**
 * struct builtins - this struct for the builtins
