...
/**
 * find_program - this find a program in path
 * @data: this a pointer to the program's data
 * Return: this 0 if success, errcode otherwise
 */
 ...
 * Return: this is an array of path directories
 */
...
/**
 * check_file - this checks s excecution permisions for permisions.
 * @full_path: this pointer to the full file name
 * Return: this 0 on success, or error code if it exists.
 */
